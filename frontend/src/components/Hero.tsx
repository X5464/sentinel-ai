...
export const Hero: React.FC = () => {
  return (
    <div className="relative text-center px-4 py-8 md:py-16 overflow-hidden">
      {/* Dynamic Background Blob - Optimized with Transforms and reduced mobile blur */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] md:w-[900px] h-[350px] md:h-[900px] bg-gradient-to-r from-blue-600/30 via-cyan-500/20 to-purple-600/30 blur-[60px] md:blur-[100px] animate-blob-bounce will-change-transform pointer-events-none" />
      
      {/* Secondary Blob for complexity */}
      <div className="absolute top-1/4 left-1/4 w-[250px] md:w-[600px] h-[250px] md:h-[600px] bg-gradient-to-t from-pink-500/20 via-purple-500/10 to-transparent blur-[50px] md:blur-[90px] animate-blob-bounce will-change-transform pointer-events-none" style={{ animationDelay: '-5s', animationDuration: '12s' }} />

      {/* Third floating accent blob */}
      <div className="absolute bottom-1/4 right-1/4 w-[200px] md:w-[400px] h-[200px] md:h-[400px] bg-cyan-400/10 blur-[50px] md:blur-[80px] animate-blob-bounce will-change-transform pointer-events-none" />
